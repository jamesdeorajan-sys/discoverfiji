...
INSERT INTO destinations (
  id, slug, name, region, summary, body_md,
  ...
  'Yasawa Islands',
  'Western Fiji',
  'A chain of volcanic islands northwest of Nadi, known for the Sawa-i-Lau limestone caves, the Blue Lagoon, and some of Fiji''s most laid-back island life.',
...
Getting there is part of the experience: most transport to the Yasawas runs via Port Denarau, so a transfer to Denarau is usually the first leg of any Yasawa trip from Nadi Airport.',
  'Yasawa Islands, Fiji — Sawa-i-Lau Caves & Blue Lagoon Guide',
  'Everything to know about visiting Fiji''s Yasawa Islands: the Sawa-i-Lau caves, the Blue Lagoon, and how to get there from Nadi via Port Denarau.',
  1
);

INSERT INTO tours (
  id, slug, name, category, destination_id, description,
  price_from, currency, duration_minutes, booking_url, active
) VALUES (
  'tour_sawa_i_lau_caves',
  'sawa-i-lau-caves-yasawa-islands-tour',
  'Sawa-I-Lau Caves (Yasawa Islands) Tour',
  'island-tour',
  'dest_yasawa_islands',
  'A full-day tour from Port Denarau out to the Yasawa Islands to swim through the Sawa-i-Lau limestone caves, including the skylit upper chamber. Real live tour on fijitourtransfers.com -- rated 4.9 from 7 reviews at last check.',
  580,
  'AUD',
  360,
  'https://fijitourtransfers.com/st_tour/sawa-i-lau-caves-yasawa-islands-tour-fiji-2/',
  1
);
